...
describe("Dashboard APIs", () => {
   ...
   * USER ACTIVITY
   */
  describe("GET /api/v1/dashboard/user/activity", () => {

    test("should allow USER activity access", async () => {
   ...
   * ADMIN SONG STATS
   */
  describe("GET /api/v1/dashboard/admin/songs", () => {
    ...
    test("should allow ADMIN access", async () => {
      ...
      const res = await request(app)
        .get("/api/v1/dashboard/admin/songs")
        .set("Authorization", `Bearer ${token}`);
   ...
   */
  describe("GET /api/v1/dashboard/super-admin/analytics", () => {
    ...
    test("should allow SUPER_ADMIN access", async () => {
      ...
      const res = await request(app)
        .get("/api/v1/dashboard/super-admin/analytics")
        .set("Authorization", `Bearer ${token}`);
